...
public class EmployeeWagesBuilderArray implements EmployeeWage {
    private int noOfCompanies = 0;
    private CompanyEmpWage[] companyEmpWages;

    public EmployeeWagesBuilderArray() {
    ...
    public static void main(String[] args) {
       //Welcome Message for Initial Purpose
        ...
        EmployeeWagesBuilderArray employeeWageBuilderArray = new EmployeeWagesBuilderArray();
